...
public record GenerateClaimsPayload(@NotBlank String identifierPrefix, @NotBlank String legalParticipantId,
    ...
    public static final String EXAMPLE_PAYLOAD = """
            ...
            """;
    /**
     * The value of this can be taken from the build runs. Just search for "Claims: " and copy the value in here.
    ...
    public static final String LIST_OF_CLAIMS = """
            {
                ...
                "@id": "https://www.gaia-x4plcaad.info/claims/virtual-resource/34779869-6907-4078-bc07-9ae1237d41df",
                "@type": "gx:InstantiatedVirtualResource",
                "gx:maintainedBy": {
                  "@id": "https://participant.gxfs.gx4fm.org/msg-systems-ag/legalParticipant.json"
                },
                "gx:hostedOn": {
                  "@id": "https://www.gaia-x4plcaad.info/claims/physical-resource/34779869-6907-4078-bc07-9ae1237d41df",
                ...
                "gx:instanceOf": {
                  "@id": "https://www.gaia-x4plcaad.info/claims/data-resource/34779869-6907-4078-bc07-9ae1237d41df",
                  ...
                  "gx:obsoleteDateTime": {
                    "@value": "2025-03-23T09:11:22",
                    "@type": "xsd:dateTime"
                  },
                  "gx:exposedThrough": {
                    "@id": "https://www.gaia-x4plcaad.info/claims/service-offering/34779869-6907-4078-bc07-9ae1237d41df"
                  },
                ...
                "gx:serviceAccessPoint": {
                  "@id": "https://www.gaia-x4plcaad.info/claims/service-access-point/34779869-6907-4078-bc07-9ae1237d41df"
                }
              },
              {
                "@context": {
